...
People use other people's services every day. They call to book an appointment or spend a lot of time to do it face to face. They rarely have a chance to make an appointment via the internet. Do you sometimes feel overwhelmed by keeping an eye on a lot of different appointments and manually entering them into your calendar? I do, and that's why the idea of an application connecting entrepreneurs with clients was born in my head.

SeeMe is the fully secured solution for clients who want to have all their appointments in one place and service providers looking for new contacts. It's easy. Create an account, enter personal data and make your life easier. As a entrepreneur you can add your terms and manage them. Clients get unique possibility to look for needed specialist and govern their appointments.
<p align="right">(<a href="#top">back to top</a>)</p>

<!-- FUNCTIONALITIES -->
## Functionalities

The application is available in polish and english. To gain access to all app functionalities you have to register and sign in. You will get email confirmation after succesful sign up. 
</br>
...
<br/>
<br/>
If you are a service provider you can enter all neccessary personal data to stay in touch with your clients and make your account attractive.
<br/>
<br/>
<br/>
<div align="center">  
...
Past terms are stored in your archive to let you see their details whenever you want. Filtering them by date or client make this qucik and simple.
...
<h3 align="center"> Client functionalities </h3>

You can search for needed specialist whenever you want and filter them by city or field. You can also select particular provider or those who have terms after a specific date. All service providers are sorted by their closest term.
...
You can see all provider's terms by opening provider details.
...
Some methods presented below are the small part of code that creates the SeeMeApp.
<br><br>
